...
frappe.ui.form.on('Student Attendance Tool', {
	...
	student_group: function(frm) {
		if ((frm.doc.student_group && frm.doc.date) || frm.doc.course_schedule) {
			var method = "insd_erpnext.acad.doctype.student_attendance_tool.student_attendance_tool.get_student_attendance_records";
	...
	get_students: function(frm, students) {
		...
		{
			frm.reload_doc()
			frappe.throw(__("Lecture not conducted.Please mark it conducted first and try again later"));
